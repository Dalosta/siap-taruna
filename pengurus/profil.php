 ...
 * ============================================================
 * FILE    : profil.php
 * LOKASI  : /pengurus/profil.php
 * FUNGSI  : Menampilkan dan mengedit data profil pengurus.
 *           Tampilan split: kiri = kartu info, kanan = form edit.
 * AUTHOR  : Muhammad Alfi — NIM 17220381 — UBSI 2026
 * ============================================================
 * 
 * CATATAN SIDANG:
 * 1. Kartu info menampilkan semua field dari database (nama,
 *    username, NIK, tempat lahir, tanggal lahir, jenis kelamin,
 *    agama, pekerjaan, status pernikahan, alamat, RT, no HP).
 * 2. Form edit memiliki field yang sama dengan kartu info.
 * 3. Password baru bersifat opsional (kosongkan jika tidak diubah).
 * 4. Action form mengarah ke handlers/proses_profil.php.
 * 5. Setelah update, session diperbarui dan redirect kembali.
 */
...
if (!$q || $q->num_rows === 0) {
    redirectDengan(APP_URL . '/pengurus/dashboard.php', 'error', 'Data profil tidak ditemukan.');
}
$data = $q->fetch_assoc();
...
<!-- ★ SCREENSHOT untuk Bab 4 → Tampilan Halaman Profil Pengurus -->
...
<div class="row g-4">
    <!-- ── 6. PANEL KIRI: KARTU INFORMASI ─────────────────────────── -->
    <div class="col-md-4">
        <div class="card-st text-center h-100">
            <div class="card-body-st" style="padding:28px 18px">
                <!-- Avatar -->
                <div style="width:70px;height:70px;
                            background:linear-gradient(135deg,var(--slate-700),var(--blue-600));
    ...
    <!-- ── 7. PANEL KANAN: FORM EDIT PROFIL ───────────────────────── -->
    <div class="col-md-8">
        <div class="card-st">
